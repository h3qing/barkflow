 ...
 *
 * Default: ~/Documents/BarkFlow Notes/
...
function getNotesDir() {
  ...
  const customDir = process.env.BARKFLOW_NOTES_DIR;
...
function saveAsMarkdown(text) {
  ...
  try {
    ...
    debugLogger.info("[BarkFlow] Saved markdown note", {
      filePath,
    ...
    debugLogger.error("[BarkFlow] Failed to save markdown note", {
      error: err.message,
    });
