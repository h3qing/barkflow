...
const WINDOW_SIZES = {
  BASE: { width: 200, height: 140 }, // WhisperWoof: Mando head + status + waveform (vertical layout)
...
class WindowPositionUtil {
  static getMainWindowPosition(display, customSize = null, position = "center") {
    ...
    if (position === "bottom-left") {
      ...
      y = Math.max(0, workArea.y + workArea.height - height - 120); // bottom-center, 120px above dock
    } else {
