...
function loadPlugins() {
  ...
  return [
    { id: "todoist", name: "Todoist", description: "Add tasks to Todoist", command: "npx @whisperwoof/todoist-mcp", enabled: false, hotkeyBinding: "Fn+T" },
    { id: "notion", name: "Notion", description: "Save notes to Notion", command: "npx @whisperwoof/notion-mcp", enabled: false, hotkeyBinding: null },
    { id: "calendar", name: "Google Calendar", description: "Add events to Google Calendar", command: "npx @whisperwoof/calendar-mcp", enabled: false, hotkeyBinding: "Fn+C" },
    { id: "slack", name: "Slack", description: "Send messages to Slack", command: "npx @whisperwoof/slack-mcp", enabled: false, hotkeyBinding: null },
  ];
}
